...
public enum Fish {
    ...
    SARDINE     ("Raw sardine"      , "Fishing rod"      , "Rod Fishing spot", "Bait"    , "Fishing bait", 5),
    KARAMBWANJI ("Raw karambwanji"  , "Small fishing net", "Fishing spot", "Net"     , "", 5),
    HERRING     ("Raw herring"      , "Fishing rod"      , "Rod Fishing spot", "Bait"    , "Bait", 10),
    ANCHOVIES   ("Raw anchovies"    , "Small fishing net", "Fishing spot", "Net"     , "", 15),
    MACKEREL    ("Raw mackerel"     , "Big fishing net"  , "Fishing spot", "Net"     , "", 16),
    TROUT       ("Raw trout"        , "Fly fishing rod"  , "Rod Fishing spot", "Lure"    , "Feather", 20),
    ...
    SALMON      ("Raw salmon"       , "Fly fishing rod"  , "Rod Fishing spot", "Lure"    , "Feather", 30),
    TUNA        ("Raw tuna"         , "Harpoon"          , "Fishing spot", "Harpoon" , "", 35),
    RAINBOW_FISH("Raw rainbow fish" , "Fly fishing rod"  , "Fishing spot", "Lure"    , "", 38),
    CAVE_EEL    ("Raw cave eel"     , "Fishing rod"      , "Rod Fishing spot", "Bait"    , "Bait", 38),
